 ...
 * {children} 容器 / {type} 类型容器），键序 = 界面呈现序，位于作者声明之前；
 * SYSTEM_CHAR_TYPES = 系统类型声明（relations 类型容器引用 relation）。
 */
...
/** 系统类型声明（relations 类型容器引用）。 */
export const SYSTEM_CHAR_TYPES = {
  relation: { children: { name: "string", impression: "string" } },
};
